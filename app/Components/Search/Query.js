            ...
            <div className="col-lg-12">
              <div className="panel panel-default">
                <div className="panel-heading">
                  <h1 className="panel-title"><strong><i className="" aria-hidden="true"></i>  Please fill out the following fields to get started</strong></h1>
                </div>
                <div className="panel-body">
                  <form>
                    ...
                    <div className="pull-right">
                      <button type="button" className="btn btn-success" onClick={this.handleSubmit}><h4>Submit</h4></button>
                    </div>
                  </form>
                </div>
              </div>
